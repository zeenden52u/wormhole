...
impl VAA {
    ...
    pub fn digest(&self) -> Option<VAADigest> {
        ...
        let body = {
            ...
            v.write_u16::<BigEndian>(self.emitter_chain as u16).ok()?;
    ...
    A: Action,
{
    ...
    #[inline]
    pub fn from_bytes(input: &[u8], chain: Chain) -> Result<Self, WormholeError> {
...
pub trait Action: Sized {
    ...
    fn from_bytes(input: impl AsRef<[u8]>, header: &GovHeader) -> Result<Self, WormholeError> {
        ...
        match Self::parse(input.as_ref(), &header).finish() {
