            ...
            S: Serializer,
        {
            ...
            match self.action {
                ...
                Action::ModifyBalance { sequence, chain_id, token_chain, token_address, kind, amount, reason } => {
                    ...
                    seq.serialize_field("chain", &self.chain)?;
                    seq.serialize_field("payload", &ModifyBalance{ sequence, chain_id, token_chain, token_address, kind, amount, reason })?;
                }
            }
    ...
    impl<'de> Visitor<'de> for GovernancePacketVisitor {
            ...
            A: SeqAccess<'de>,
        {
            ...
            let action = match act {
                ...
                3 => {
                    let ModifyBalance { sequence, chain_id, token_chain, token_address, kind, amount, reason } = seq
                        .next_element()?
                        .ok_or_else(|| Error::invalid_length(3, &EXPECTING))?;
                    Action::ModifyBalance { sequence, chain_id, token_chain, token_address, kind, amount, reason }
                }
                ...
                match key {
                    ...
                    Field::Payload => {
                        ...
                        let p = match a {
                            ...
                            3 => {
                                let ModifyBalance { sequence, chain_id, token_chain, token_address, kind, amount, reason } = map.next_value()?;
                                Action::ModifyBalance { sequence, chain_id, token_chain, token_address, kind, amount, reason }
                            }
                            v => {
                                return Err(Error::custom(format_args!(
