...
```console
wormhole/terra2 $ make artifacts
```
...
```console
wormhole/terra2 $ cat artifacts/checksums.txt
```
...
```console
wormhole/terra2 $ make deploy/bridge
wormhole/terra2 $ make deploy/token_bridge
wormhole/terra2 $ make deploy/nft_bridge
```
...
```console
wormhole/terra2 $ ./verify artifacts/wormhole.wasm NEW_BRIDGE_CODE_ID
wormhole/terra2 $ ./verify artifacts/token_bridge.wasm NEW_TOKEN_BRIDGE_CODE_ID
wormhole/terra2 $ ./verify artifacts/nft_bridge.wasm NEW_NFT_BRIDGE_CODE_ID
```
