...
async function main() {
  ...
  const host = devnetConsts.chains[WORMCHAIN_ID].tendermintUrlLocal
  ...
  const redeemCW20Token = ""
  const redeemWormToken = ""
  ...
  const attestERC20Token = ""
  ...
  const redeemERC20Token = ""
  ...
  const observations = [
    {
      emitter_chain: 2,
      emitter_address: Array.from(fromHex(emitter_address)),
      sequence: 2,
      nonce: 1,
      consistency_level: 0,
      timestamp: 1,
  ...
  console.debug(JSON.stringify(inst, undefined, "  "))


  // send it again and expect it to fail
  try {
    await cwc.execute(
      signer,
      accountingAddress,
    ...
    throw new Error("submitting observation twice succeeded.")
  } catch (_) {
    // expected it to fail with:
    // "failed to handle `Observation`: message already processed"
  }
